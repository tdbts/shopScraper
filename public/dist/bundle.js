...
},{"./ShopScraper":169,"react":158}],2:[function(require,module,exports){
...
},{"./CollapsibleListItem":159,"react":158}],161:[function(require,module,exports){
var React = require('react'), 
...
},{"./CollapsibleUnorderedList":160,"react":158}],162:[function(require,module,exports){
var React = require('react');
...
},{"./Spinner":171,"react":158}],164:[function(require,module,exports){
var React = require('react');
...
},{"./Navbar":164,"./SidePanel":170,"react":158}],166:[function(require,module,exports){
var React = require('react');

var ProductCarousel = React.createClass({displayName: "ProductCarousel",
	...
	checkIfControlsRequired: function () {
		if (this.props.products.length > 1) {
			return (
				React.createElement("div", {id: this.getCarouselID() + "_control_container"}, 
					React.createElement("a", {className: "left carousel-control", href: "#" + this.getCarouselID(), role: "button", "data-slide": "prev"}, 
					...
					React.createElement("a", {className: "right carousel-control", href: "#" + this.getCarouselID(), role: "button", "data-slide": "next"}, 
	...
	render: function () {
		...
		return (
			React.createElement("div", {id: this.getCarouselID(), className: this.getCarouselClass(), "data-ride": this.getDataRideValue(), "data-interval": "false"}, 
...
var ProductComponent = React.createClass({displayName: "ProductComponent",
	...
	render: function () {
		...
		return (
			React.createElement("div", {className: productClassBase + productClassAddtion}, 
...
},{"./DefaultLocationsSelector":162,"./LoadingOverlay":163,"./Navigation":165,"./ViewListings":174,"./Welcome":175,"react":158}],170:[function(require,module,exports){
var React = require('react'), 
...
var SidePanel = React.createClass({displayName: "SidePanel",
	...
	render: function () {
		...
		return (
		    React.createElement("div", {className: "navbar-default sidebar", role: "navigation", style: this.state.sidePanelHeight}, 
...
},{"./CollapsingPanelOption":161,"./SearchField":168,"jquery":3,"react":158}],171:[function(require,module,exports){
var React = require('react');
...
var StoreCircularComponent = React.createClass({displayName: "StoreCircularComponent",
	...
	render: function () {
		...
		return (
			React.createElement("div", {id: "store_circular_component_viewport_wrapper"}, 
				React.createElement("div", {className: "store_circular_component hidden-sm hidden-xs"}, 
				...
				React.createElement("div", {className: "store_circular_component hidden-md hidden-lg"}, 
					React.createElement("div", {className: "store_header_component"}, 
						React.createElement("h1", {className: "header_store_name"}, this.props.storeName)
					), 
					React.createElement("div", {className: "store_circular_date_component"}, 
					...
					React.createElement("div", {className: "container_circular_products"}, 
						React.createElement(ProductCarousel, {storeName: this.props.storeName, products: this.props.products})
					)					
				)
			)
		);
...
},{"./ProductCarousel":166,"react":158}],173:[function(require,module,exports){
var React = require('react');
			...
			React.createElement("div", {id: "three_columns_view"}, 
				React.createElement("div", {id: "container_three_columns", className: "container"}, 
					React.createElement("div", {id: "three_columns_row", className: "row"}, 
						React.createElement("div", {id: "column_left", className: "col-md-3 store_listings_column"}, 
							this.props.listings[0]
						), 
						React.createElement("div", {className: "col-md-1 space_column"}), 
						React.createElement("div", {id: "column_middle", className: "col-md-3 store_listings_column"}, 
							this.props.listings[1]
						), 
						React.createElement("div", {className: "col-md-1 space_column"}), 
						React.createElement("div", {id: "column_right", className: "col-md-3 store_listings_column"}, 
...
var ViewListings = React.createClass({displayName: "ViewListings",
	...
	handleEmptyFilterResults: function (arr) {
		arr.push(React.createElement(ProductComponent, {key: "1", productName: "No Matching Products Found", productDescription: "Your search did not return any results for this store.", price: "Zilch.", imageUrl: "http://dulieu.phim.pw/images/hinh404.png"}));
	}, 
	...
	collectProductComponents: function (productData, dest) {
		...
		if ($(window).width() > 992) {
			...
			dest.push(React.createElement(ProductComponent, React.__spread({key: productData.shsc_id},  productData, {carousel: carouselBool, active: activeBool}))); 
		}
	}, 
...
},{"./ProductComponent":167,"./StoreCircularComponent":172,"./ThreeColumnsView":173,"jquery":3,"react":158}],175:[function(require,module,exports){
var React = require('react'), 
...
},{"./WelcomeColumn":176,"react":158}],176:[function(require,module,exports){
var React = require('react');
